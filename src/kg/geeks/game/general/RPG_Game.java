...
public class RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss(1000, 130, "Evil");
        ...
        Kamikadze kamikadze = new Kamikadze(500,0,"kamikadzeDied");
        Thor thor = new Thor(210,27,"Odinson");
        TrickyBastard trickyBastard = new TrickyBastard(400,15,"Trick");
